...
console.log('You cannot end a sentence with because because because is a conjunction'.indexOf('cannot'));

// 18. Use lastIndexOf to find the position of the last occurrence of the word because in the following sentence:'You cannot end a sentence with because because because is a conjunction'

console.log('You cannot end a sentence with because because because is a conjunction'.lastIndexOf('conjunction'));

//19. Use search to find the position of the first occurrence of the word because in the following sentence:'You cannot end a sentence with because because because is a conjunction'

console.log('You cannot end a sentence with because because because is a conjunction'.search('You'));
...
let fifty = Math.random() * (100 - 50+1) + 50;

console.log(fifty)

//9. Generate a random number between 0 and 255 inclusively.

let twofiftyfayb = Math.random() * 256;

console.log(twofiftyfayb)
...
console.log((String(Math.floor(Math.random() * 100)).repeat(5) + "\n").repeat(5))
...
console.log(sentence.substring(0,38) , sentence.substring(55,75))
...
let pattern = /love/gi
console.log(sentence2.match(pattern).length)
...
let pattern3 = /\d+/g;
let match = problem.match(pattern3)
let salarypermonth = parseInt(match[0])
let annualbonus = parseInt(match[1])
let coursespermonth = parseInt(match[2])
let totalAnnualSalary = parseInt((salarypermonth * 12) + (coursespermonth *12) + annualbonus);

console.log(`He earns total annual salary of ${totalAnnualSalary}`);
